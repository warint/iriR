...
Country set to Canada by default, if no country code but argument, only top 5. 


### Barchart on Top 5 countries for number of leading companies in R&D

Country set to Canada by default, if there is no country code but an empty argument, only top 5 like as below. 
